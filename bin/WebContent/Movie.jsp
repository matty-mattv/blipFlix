...
<style>
    ...
    <title>Movie Site - Movie Detail</title>
</head>
<body>
...
<div class="wrapper"  align="center">
        ...
        <%if (fullname == null) {%>
        		<form action="AddToCart">
        			<button name="AddToCart" class="btn btn-primary">Add to cart</button>
        		</form>
        <%} else {%>
        <div class='p-3 mb-2 bg-light'>Add to cart feature is disabled on Employee Dashboard</div>
        <% } %>
        <p></p>
